...
const VerifyAccountForm = () => {
    ...
    return (
      <Box component='form' onSubmit={handleSubmit}>
        <TextField margin='normal' required fullWidth label='Enter the validation code' name='validation_code' sx={{ mt: 5, mb: 5 }} helperText='5 ALPHAnumeric characters' inputProps={{ pattern: '[0-9A-Z]{5}' }}/>
